...
Vec3f trace(Ray &ray, std::vector<Object *> objects, std::vector<Sphere *> lightings, /*Model *model,*/int depth){
    ...
    if(object != NULL){
        ...
        if(object->Ksp>0 && depth<MAX_DEPTH){
            ...
            color += ( reflColor* fresneleffect  *std::max(0.0, pow(h.dot(nhit),object->Fsp))) *object->Ksp ;//surfacecolor
        }
...
int main(int argc, const char * argv[]) {
    ...
    char imagePath[200];
    //char modelPath[200];
    char defaultimagePath[200] = "/Users/user/Desktop/ACG/RayTracing-master/raytracing/profile_photo.bmp";
    //char defaultmodelPath[200] = "/Users/user/Desktop/ACG/RayTracing-master/raytracing/bunny_100.txt";
    ...
    //Sphere * sphere2 =new Sphere(Vec3f(7,4,1.5),1.5,Vec3f(0.5f,1.0f,1.0f),1,0);
    //sphere2->setTextureMapping(imagePath);
    ...
    Camera camera(Vec3f(20,5,5), Vec3f(5,5,5), Vec3f(-1.73,0,1),90);
...
//    glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);
    ...
    GLFWwindow* window = glfwCreateWindow(WINDOW_WIDTH/2, WINDOW_HEIGHT/2, "Ray Tracing", nullptr, nullptr);
    if (window == nullptr)
    {
